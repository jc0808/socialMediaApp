...
Follower.create(following_id: p2.id, profile_id: p1)
Follower.create(following_id: p3.id, profile_id: p1)
Follower.create(following_id: p1.id, profile_id: p2)
Follower.create(following_id: p1.id, profile_id: p3)
Follower.create(following_id: p3.id, profile_id: p2)
