...
user1 = User.create(username: "joshua123", password: "josh123")
user2 = User.create(username: "lucas123", password: "lucas123")
user3 = User.create(username: "shafeska123", password: "shafes123")
